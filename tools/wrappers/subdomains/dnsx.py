...
class DnsxTool:
    ...
    def run(self, host_list: str = None, domain: str = None) -> dict:
        self.logger.info(f"Running dnsx...")
        try:
            ...
            if host_list:
                ...
                return {"error": "host_list or domain must be provided to dnsx"}
            ...
            return {"error": "dnsx command not found. See https://github.com/projectdiscovery/dnsx"}
        except subprocess.TimeoutExpired:
            return {"error": "dnsx command timed out"}
